...
function NotificationDropdown({ onClose, triggerRef }) {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-0 mt-2 w-80 max-h-[480px] flex flex-col rounded-xl bg-surface-container-lowest shadow-lg ring-1 ring-outline-variant/30 z-[1100] overflow-hidden"
      role="dialog"
