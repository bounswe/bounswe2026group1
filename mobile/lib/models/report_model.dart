...
const List<ReportModel> mockReports = [
  ReportModel(
    ...
    longitude: -122.4148,
    description:
        'Significant structural crack spanning approximately 4 feet across the main pedestrian crossing. Deep enough to catch bicycle tires and poses a trip hazard for elderly residents.',
    tag: ReportTag.missingRamp,
    status: ReportStatus.verified,
    agrees: 78,
    disagrees: 6,
    publishDate: '2026-03-27T10:15:00',
    mediaUrls: [],
  ),
  ReportModel(
    reportId: 2,
    ...
    longitude: -122.4094,
    description:
        'Large graffiti tags covering the exterior wall of a local business. Multiple layers of paint applied over recent weeks, damaging the building facade.',
    tag: ReportTag.construction,
    status: ReportStatus.pending,
    agrees: 31,
    disagrees: 10,
    publishDate: '2026-03-28T14:30:00',
    mediaUrls: [],
  ),
  ReportModel(
    reportId: 3,
    ...
    longitude: -122.4071,
    description:
        'Street light has been non-functional for over a week creating a safety concern for pedestrians and cyclists during night hours.',
    tag: ReportTag.brokenElevator,
    status: ReportStatus.pending,
    agrees: 55,
    disagrees: 8,
    publishDate: '2026-03-26T08:45:00',
    mediaUrls: [],
  ),
  ReportModel(
    reportId: 4,
    ...
    longitude: -122.4180,
    description:
        'Wet floor near the main building entrance with no warning signs. Several people have slipped. Needs immediate attention.',
    tag: ReportTag.wetFloor,
    status: ReportStatus.verified,
    agrees: 42,
    disagrees: 3,
    publishDate: '2026-03-29T09:00:00',
    mediaUrls: [],
  ),
  ReportModel(
    reportId: 5,
    ...
    longitude: -122.4130,
    description:
        'Corridor is too narrow for wheelchair users. Parked bikes are blocking further reducing the passable width.',
    tag: ReportTag.narrowPassage,
    status: ReportStatus.pending,
    agrees: 19,
    disagrees: 2,
    publishDate: '2026-03-29T11:20:00',
    mediaUrls: [],
  ),
];
