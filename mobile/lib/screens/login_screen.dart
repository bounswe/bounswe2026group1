...
class _LoginScreenState extends State<LoginScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(hint: 'name@example.com', keyboardType: TextInputType.emailAddress),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {},
                          child: const Text('Forgot Password?', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.primary)),
                        ),
                      ],
                    ),
                    const SizedBox(height: 6),
                    ...
                    _buildPrimaryButton('Sign In', onTap: () {}),
  ...
  Widget _buildPrimaryButton(String label, {required VoidCallback onTap}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(label, textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Plus Jakarta Sans', fontWeight: FontWeight.w700, fontSize: 16, color: AppColors.onPrimary)),
      ),
    );
  }
  ...
  Widget _buildDivider(String label) {
    return Row(
      children: [
        Expanded(child: Divider(color: AppColors.surfaceContainerHigh, thickness: 1)),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 12),
          child: Text(label, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, letterSpacing: 1.2, color: AppColors.outlineVariant)),
        ),
        Expanded(child: Divider(color: AppColors.surfaceContainerHigh, thickness: 1)),
      ],
    );
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Container(
              width: 18, height: 18,
              decoration: BoxDecoration(color: const Color(0xFFEA4335), borderRadius: BorderRadius.circular(3)),
              child: const Center(child: Text('G', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12))),
            ),
            const SizedBox(width: 8),
            const Text('Google', style: TextStyle(fontWeight: FontWeight.w600, color: AppColors.onSurface, fontSize: 14)),
          ],
        ),
      ),
    );
  ...
  Widget _buildAppleButton() {
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(vertical: 13),
        decoration: BoxDecoration(color: AppColors.inverseSurface, borderRadius: BorderRadius.circular(14)),
        child: const Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.apple, color: Colors.white, size: 18),
            SizedBox(width: 8),
            Text('Apple', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.white, fontSize: 14)),
          ],
        ),
      ),
    );
